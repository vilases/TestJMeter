El script verCSV.py ejecuta los TC de JMeter que estan en el mismo directorio. Es necesario tener JMeter instalado (y por tanto JAVA) en el dispositivo asi como python.
